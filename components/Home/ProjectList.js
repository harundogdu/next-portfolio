  ...
  const [projects, setProjects] = useState([
    {
      ...
      description: "With Laravel 8.* ,The construction of an advanced personal website website application that I have developed.",
    },
    {
      id: 2,
      title: "Quizzers",
      url: "https://quizzers.harundogdu.com/",
      description: "With Laravel 8.* ,The construction of an advanced quiz website application that I have developed.",
    },
    {
      id: 3,
